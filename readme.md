...
I decided to create a spellbook/cookbook type application that would allow the user to create spells, as well as add and remove ingredients from each spell.

The one to many relationship between ingredients and spells is currently not working however ingredients can be added and removed and spells can be added and removed as seperate entities.
